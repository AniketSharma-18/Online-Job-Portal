        ...
        <div class="main_center_division">
            ...
            <div class="user_details">
                ...
                <%
                    ...
                    String date11=(String)request.getAttribute("dateee");
                    String time11=(String)request.getAttribute("timeee");
                    String job_id11=null;
                        try
                        {
                             Class.forName("com.mysql.jdbc.Driver");
                   Connection con=DriverManager.getConnection("jdbc:mysql:///interview","root","sst");
                            PreparedStatement ps=con.prepareStatement("select * from SEND_SELECTION_CONFIRMATION where DATE1='"+date11+"' and TIME1='"+time11+"'");
                            ResultSet rs=ps.executeQuery();
                            while(rs.next())
                            {
                                company_email11=rs.getString("COMPANY_EMAIL");
                                job_id11=rs.getString("JOB_ID");
                                message11=rs.getString("MESSAGE");
                            }
                        }
                        catch(Exception e)
                        {
                ...
                %>
                    ...
                    <div class="status_update_name_division11">
                        <table>
                            ...
                            <tr>
                                <td class="table_td_jobpost"> MESSAGE : </td>
                                <td> <%= message11 %> </td>
                            </tr>
