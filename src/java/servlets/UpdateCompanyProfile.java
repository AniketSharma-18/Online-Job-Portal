...
public class UpdateCompanyProfile extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String ccity1=request.getParameter("ccity1");
         ...
         try
        {
            ...
            PreparedStatement ps=con.prepareStatement("UPDATE COMPANY_REGISTER set NAME='"+cname1+"', CITY='"+ccity1+"' where EMAIL='"+cemail+"'");            
            ps.executeUpdate();
